...
**[Try the live demo →](https://kaviya04.github.io/invoice-processing-agent/)**
(runs the actual validation logic in your browser against the same fixture
data the repo uses in `MOCK_MODE` — no sign-in, no API key needed)
